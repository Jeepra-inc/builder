...
interface NewBannerComponentType extends FC<any> {
  schema?: SectionSchema;
}

export const newBannerSchema: SectionSchema = {
  name: 'newBanner',
  type: SectionType.NewBanner,
  schema: [
    {
      id: 'title',
      type: 'text',
...
/**
 * NewBannerComponent renders a customizable moderBanner section based on the provided schema and settings.
 */
const NewBannerComponent: NewBannerComponentType = withSection({
  schema: newBannerSchema,
...
NewBannerComponent.schema = newBannerSchema;
export { NewBannerComponent };
