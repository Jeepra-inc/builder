...
export function HeaderButtonSettings({ settings = {}, onUpdateSettings, contentRef, selectedSetting }: HeaderButtonSettingsProps) {
  const [buttonSettings, setButtonSettings] = useState<Record<string, ButtonSettings>>({});
  ...
  }, [settings.button_1_text, settings.button_1_url, settings.button_1_style, settings.button_1_target,
      settings.button_2_text, settings.button_2_url, settings.button_2_style, settings.button_2_target]);
  
  // Update settings when a button field changes
  const handleButtonUpdate = (buttonId: string, field: string, value: string) => {
    ...
    return (
      <div className="space-y-4 p-3 border rounded-md">
        <div className="space-y-2">
          ...
          <Input
            value={button.text}
            onChange={(e) => handleButtonUpdate(buttonId, 'text', e.target.value)}
        ...
        <div className="space-y-2">
          ...
          <Input
            value={button.url}
            onChange={(e) => handleButtonUpdate(buttonId, 'url', e.target.value)}
        ...
        <div className="space-y-2">
          ...
          <Select
            value={button.target}
            onValueChange={(value) => handleButtonUpdate(buttonId, 'target', value)}
          >
            <SelectTrigger>
        ...
        <div className="space-y-2">
          ...
          <Select
            value={button.style}
            onValueChange={(value) => handleButtonUpdate(buttonId, 'style', value)}
          >
            <SelectTrigger>
